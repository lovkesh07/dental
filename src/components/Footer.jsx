...
const Footer = () => {
  return (
    <div>
      <footer className="bg-blue-200 bg-cover bg-fixed bg-top bg-no-repeat ">
        <section>
          <div className="py-4 ">
            <nav className="mt-10 text-md" aria-label="quick links">
              <div className="-my-1 flex justify-center gap-x-4 lg:gap-x-6 px-4 ">
                ...
                <a className="hover:text-slate-200" href="/tests">
                  Services
                </a>
                <a className="hover:text-slate-200" href="/tests">
                  Accesspries
          ...
          <div className="flex flex-col items-center border-t border-black py-10 sm:flex-row-reverse sm:justify-between lg:mx-10">
            ...
            <p className="mt-6 text-sm text-black sm:mt-0">
              Copyright &copy; {new Date().getFullYear()} Chauhan dental
              Laboratory. All rights reserved. | Designed By{" "}
              <Link
