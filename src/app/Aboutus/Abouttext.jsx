...
const Abouttext = () => {
  return (
    <div id="diagnoos">
      <div className="bg-gradient-to-t from-white from-10% via-white via-10% to-[#8cb8f1] to-90% pb-10">
        <div className="pt-22 overflow-hidden sm:mt-0 sm:pt-20">
          <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                <h2 className="text-3xl lg:text-6xl tracking-tight text-gray-900 sm:text-4xl  font-extrabold" data-aos="fade-up">
